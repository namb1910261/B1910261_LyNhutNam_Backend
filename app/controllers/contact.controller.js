...
// Retrieve all contact of a user from the database
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        return next(
            new ApiError(500, `Error retrieving contact with id=${req.param.id}`)
        );
    }
};

// update a contact by the id in the contact
